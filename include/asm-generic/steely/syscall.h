 ...
 * 02111-1307, USA.
 */
#ifndef _STEELY_ASM_GENERIC_SYSCALL_H
#define _STEELY_ASM_GENERIC_SYSCALL_H
...
static inline int steely_copy_from_user(void *dst, const void __user *src,
					size_t size)
{
...
static inline int steely_copy_to_user(void __user *dst, const void *src,
				      size_t size)
{
...
static inline int steely_strncpy_from_user(char *dst, const char __user *src,
					   size_t count)
{
...
#define __STEELY_COMPAT_BIT	0x1
/* 32bit syscall emulation - extended form */
#define __STEELY_COMPATX_BIT	0x2

#endif /* !_STEELY_ASM_GENERIC_SYSCALL_H */
