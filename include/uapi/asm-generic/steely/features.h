 ...
 */
#ifndef _STEELY_UAPI_ASM_GENERIC_FEATURES_H
#define _STEELY_UAPI_ASM_GENERIC_FEATURES_H
...
struct steely_featinfo {
	...
	struct steely_featinfo_archdep feat_arch;
};
...
{
	return abirev == STEELY_ABI_REV;
}

#endif /* !_STEELY_UAPI_ASM_GENERIC_FEATURES_H */
