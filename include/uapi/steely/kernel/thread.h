 ...
 */
#ifndef _STEELY_UAPI_KERNEL_THREAD_H
#define _STEELY_UAPI_KERNEL_THREAD_H

#include <uapi/steely/kernel/types.h>

/**
 * @ingroup steely_core_thread
 * @defgroup steely_core_thread_states Thread state flags
...
/**
 * @ingroup steely_core_thread
 * @defgroup steely_core_thread_info Thread information flags
...
#endif /* !_STEELY_UAPI_KERNEL_THREAD_H */
