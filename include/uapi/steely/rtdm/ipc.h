 ...
 *   @c /proc/steely/registry/rtipc/xddp/@em label, where @em label is the
 ...
 *   /proc/steely/registry/rtipc/iddp/@em label, where @em label is
 ...
 *
 *   @em sipc_family must be AF_RTIPC, @em sipc_port is either -1,
 *   or a valid free port number between 0 and CONFIG_STEELY_BUFP_NRPORT-1.
 *
 ...
 *   the socket to a port, a registry link referring to the assigned
 *   port number will be automatically set up as @c
 *   /proc/steely/registry/rtipc/bufp/@em label, where @em label is
