 ...
 */
#ifndef _STEELY_UAPI_SIGNAL_H
#define _STEELY_UAPI_SIGNAL_H
...
#define STEELY_DELAYMAX			2147483647U
 ...
 *
 * siginfo_t si;
 * struct bar *p = __steely_si_extra(&si, _rt, struct bar);
 *
...
#define __steely_si_extra(__si, __basefield, __type)				\
...
#define __steely_sev_extra(__sev, __basefield, __type)				\
