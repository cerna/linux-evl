 ...
 */
#undef TRACE_SYSTEM
#define TRACE_SYSTEM steely_core
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_FILE steely-core

#if !defined(_TRACE_STEELY_CORE_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_STEELY_CORE_H
