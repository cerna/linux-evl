 ...
 */
#undef TRACE_SYSTEM
#define TRACE_SYSTEM steely_rtdm
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_FILE steely-rtdm

#if !defined(_TRACE_STEELY_RTDM_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_STEELY_RTDM_H
