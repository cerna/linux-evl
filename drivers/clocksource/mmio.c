...
static void user_mmio_clksrc_mapping_close(struct vm_area_struct *vma)
{
...
static const struct vm_operations_struct user_mmio_clksrc_mapping_vmops = {
	.close = &user_mmio_clksrc_mapping_close,
};
...
static int user_mmio_clksrc_mmap(struct file *file, struct vm_area_struct *vma)
{
	...
	vma->vm_ops = &user_mmio_clksrc_mapping_vmops;
