 ...
 */
#ifndef _STEELY_ARM_ASM_UAPI_FPTEST_H
#define _STEELY_ARM_ASM_UAPI_FPTEST_H

#define __STEELY_HAVE_VFP  0x1
...
#endif /* !_STEELY_ARM_ASM_UAPI_FPTEST_H */
