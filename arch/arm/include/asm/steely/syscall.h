 ...
 * 02111-1307, USA.
 */
#ifndef _STEELY_ARM_ASM_SYSCALL_H
#define _STEELY_ARM_ASM_SYSCALL_H
...
#define __xn_syscall_p(__regs)	(((__regs)->ARM_r7 == __NR_OABI_SYSCALL_BASE + __ARM_NR_dovetail) || \
				 ((__regs)->ARM_r7 == __ARM_NR_dovetail))
#else /* !CONFIG_OABI_COMPAT */
#define __xn_syscall_p(__regs)	((__regs)->ARM_r7 == __ARM_NR_dovetail)
#endif /* !CONFIG_OABI_COMPAT */
#define __xn_syscall(__regs)	(__xn_reg_sys(__regs) & ~__STEELY_SYSCALL_BIT)
...
#endif /* !_STEELY_ARM_ASM_SYSCALL_H */
