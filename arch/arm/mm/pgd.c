...
#if defined(CONFIG_FORCE_COMMIT_MEMORY) && __LINUX_ARM_ARCH__ < 6
/*
 ...
 * active PGDs.
 *
 * We disable this feature for v6 and above, for which handling minor
 * faults is reasonably cheap.
 */
...
#else  /* !(CONFIG_FORCE_COMMIT_MEMORY && __LINUX_ARM_ARCH__ < 6) */
...
#endif  /* !(CONFIG_FORCE_COMMIT_MEMORY && __LINUX_ARM_ARCH__ < 6) */
