...
static void ioapic_ack_level(struct irq_data *irq_data)
{
	...
	/*
	 * If pipelining, we must prevent low priority IRQs grabbed by
	 * high priority domains from being delayed, waiting for a
	 * high priority interrupt handler running in a low priority
	 * domain to complete.  This code assumes hw interrupts off.
	 */
	if (irqs_pipelined()) {
		i = cfg->vector;
