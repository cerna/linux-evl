 ...
 *  PIPELINE		- traversing the pipeline entry code
 *  HEAD_STAGE		- running over the head stage
...
enum trace_flag_type {
	...
	TRACE_FLAG_NMI			= 0x40,
	TRACE_FLAG_PIPELINE		= 0x80,
	TRACE_FLAG_HEAD_STAGE		= 0x100,
	TRACE_FLAG_IRQS_DISABLED	= 0x200,
};
