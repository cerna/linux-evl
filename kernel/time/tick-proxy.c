		       ...
		       const struct cpumask *cpumask)
{
	...
	/*
	 * Start ticking from the head interrupt stage via out-of-band
	 * events.
	 */
	stop_machine_pipelined(enable_oob_timer, ops, cpumask);
			  ...
			  const struct cpumask *cpumask)
{
	 ...
	 */
	stop_machine_pipelined(disable_oob_timer, NULL, cpu_online_mask);
