#define __STEELY_CALL_ENTRIES \
	...
	__STEELY_CALL_ENTRY(event_init) \
	__STEELY_CALL_ENTRY(event_wait) \
	__STEELY_CALL_ENTRY(event_sync) \
	__STEELY_CALL_ENTRY(event_destroy) \
	__STEELY_CALL_ENTRY(event_inquire) \
...
#define __STEELY_CALL_MODES \
	...
	__STEELY_MODE(event_init, current) \
	__STEELY_MODE(event_wait, primary) \
	__STEELY_MODE(event_sync, current) \
	__STEELY_MODE(event_destroy, current) \
	__STEELY_MODE(event_inquire, current) \
